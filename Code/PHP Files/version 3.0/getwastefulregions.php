...
//get wasteful regions by plugload
...
//get wasteful regions that left light on with no occupants
...
if (mysqli_num_rows($result) > 0) {
	...
	$list[] = array('region_name' => $row["region_name"], 'description' => "null", 'plugload' => $row["plugload"]);
    }
