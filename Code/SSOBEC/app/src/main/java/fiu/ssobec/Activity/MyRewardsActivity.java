...
public class MyRewardsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //User that is currently logged in is found
            ...
            user_id = user.getId();
            rewardLoader loader = new rewardLoader(this,user);
...
*/
    ...
    */
    private class rewardLoader extends AsyncTask<String, Void, String> {


        Context context;
        User user;
        ArrayList<RewardListParent> rewards_list;
        int total_rewards = 0;
        public rewardLoader( Context context, User user) {
        ...
        protected String doInBackground(String... params) {
            ...
            String res = null;
            rewards_list = new ArrayList<RewardListParent>();
            total_rewards = 0;
        ...
        protected void onProgressUpdate(Void... values) {
            ...
            ListView listview_rewards = (ListView) findViewById(R.id.rewards_table);
            MyRewardListAdapter myRewardListAdapter = new MyRewardListAdapter(context);
            myRewardListAdapter.setParents(rewards_list);
            listview_rewards.setAdapter(myRewardListAdapter);
        }
    }
