...
public class MyZoneListAdapter implements ListAdapter {
    ...
    public MyZoneListAdapter(Context context) {
        inflater = LayoutInflater.from(context);
        mContext = context;
    }

    public MyZoneListAdapter(Context context, FragmentManager fm) {
        inflater = LayoutInflater.from(context);
        mContext = context;
        this.fm = fm;
    }
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_zone_list, parent, false);
            mViewHolder.zone_name = (TextView) convertView.findViewById(R.id.zone_name);
            mViewHolder.imgplus = (ImageView) convertView.findViewById(R.id.zoneplus_icon);
        ...
        mViewHolder.imgplus.setOnClickListener(new View.OnClickListener() {
            @Override
