...
public class UserSQLiteDatabase extends SQLiteOpenHelper {
    ...
    private static final String LIGHT_TABLE_CREATE = "create table "
            ...
            + LIGHT_COLUMN_ENERGY + " double NOT NULL, "
    ...
    private static final String STAT_TABLE_CREATE = "create table "
            ...
            + STAT_LIGHTING_ENERGYUSAGE + " double NULL, "
            + STAT_LIGHTING_ENERGYWASTE + " double NULL, "
            + STAT_PLUGLOAD_ENERGYWASTE + " double NULL, "
            + STAT_PLUGLOAD_ENERGYUSAGE + " double NULL, "
