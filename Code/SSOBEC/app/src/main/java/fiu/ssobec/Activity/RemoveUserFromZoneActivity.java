...
public class RemoveUserFromZoneActivity extends ActionBarActivity {

    public static final String LOG_TAG = "fiu.ssobec.RemoveUserFromZoneActivity";
    public static final String ADDUSERTOZONE_PHP = "http://smartsystems-dev.cs.fiu.edu/removeuserfromzone.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remove_user_from_zone);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_remove_user_from_zone, menu);
        return true;
    }
    ...
    public void removeUserFromZone(View view){
