...
import fiu.ssobec.Adapters.MyZoneEditUsersListAdapter;
...
public class EditZoneUsersActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyZoneEditUsersListAdapter myZoneEditUsersListAdapter = new MyZoneEditUsersListAdapter(this, fm);
        myZoneEditUsersListAdapter.setParents(parents);
        mListView.setAdapter(myZoneEditUsersListAdapter);
    }
